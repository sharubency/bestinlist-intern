...
converter.config(bg="grey")
photo = PhotoImage(file = "icon.png")
converter.iconphoto(False, photo)
...
appName = Label(converter,text="Currency Converter",font=("arial",25,"bold","underline"),fg="black",bg="grey")
appName.place(x=150, y=10)

result = Text(converter,height=5,width=50,font=("arial",10,"bold"),bd=5,fg="black",bg="grey")
result.place(x=125, y=60)

india = Label(converter,text="Value in indian Rupees:",font=("arial",10,"bold"),fg="black",bg="grey")
india.place(x=30, y=165)

rupees = Entry(converter,font=("arial",20),fg="black",bg="grey")
rupees.place(x=200, y=160)

choice = Label(converter,text="Choice:",font=("arial",10,"bold"),fg="black",bg="grey")
...
button = Button(converter,text="Convert",fg="black",font=("arial",20),bg="grey",command=currency_convert)
